...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \verb|Requests, Tornado >= 4.0,  PyYaml, DateUtil|). Since this particular framework assumes the installation of these python libraries, it is very difficult for a user to quicky execute and obtain results by merely running the script. \newline
